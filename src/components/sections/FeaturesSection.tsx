    ...
    <section className="relative md:mx-10 mx-5 mt-12">
      ...
      <div className="relative w-full mb-14 px-4 md:px-8 lg:px-16">
        <div className="lg:block relative w-full md:min-h-[751px] mx-auto">
          ...
          <div className="absolute top-[20%] left-[70%] translate-x-[58%] lg:flex flex-col hidden w-[252px] h-[270px] bg-accent px-4 py-16 text-center">
          ...
          <div className="absolute top-[52%] left-[46%] -translate-x-[225%] lg:flex flex-col hidden w-[252px] h-[270px] bg-accent px-4 py-16 text-center">
